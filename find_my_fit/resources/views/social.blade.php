            ...
            <div class="container-fluid">
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link active" href="/social_page">Discover</a>
                  </li>
                  <li class="nav-item">
                ...
                <form class="d-flex" action="/search_user" method="GET" role="search">
                  {{ csrf_field() }}
                  <div class="input-group">
                      <input type="text" class="form-control me-2" name="search_user"
                ...
                <div class="col">
                    <div class="card text-dark bg-light" style="max-width: 18rem;">
                        ...
                        <form method="post" action="{{ route('get_other_account') }}"
                            ...
                            <input class="btn btn-outline-info" type="submit" value="view account" >
                        ...
                        <form method="post" action="{{ route('follow') }}"
                            ...
                            @csrf
                            <input type='hidden' name='user_id' value='{{ $person->id}}'>
                            <input class="btn btn-outline-info" type="submit" value="follow" >
